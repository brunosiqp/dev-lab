...
BASE_URL = "https://shein.inventti.app/cte2/api/v2/documentos-fiscais"
ARQUIVO_CHAVES = "chaves.txt"
MAX_THREADS = 10
DELAY_ENTRE_REQUISICOES = 0.0
LOG_FILE = "resultado.log"
PASTA_RESPONSE = "responses"
...
def salvar_response(chave, conteudo):
    os.makedirs(PASTA_RESPONSE, exist_ok=True)
    caminho = os.path.join(PASTA_RESPONSE, f"{chave}.json")
...
def processar_chave(chave):
    ...
    headers = {
        "x-api-key": API_KEY,
        "incluir-resposta-protocolada": "true"
    }
    ...
    try:
        ...
        salvar_response(chave, conteudo)
